...
# API Keys
GOOGLE_API_KEY = "YOUR_GOOGLE_API_KEY_HERE"  # Replace with your key
NASA_API_KEY = "YOUR_NASA_API_KEY_HERE"      # Replace with your key
...
# Emergency services with Google Maps links
...
**Response Units**: {selected_fire.get("response_units", "N/A")}
""")
